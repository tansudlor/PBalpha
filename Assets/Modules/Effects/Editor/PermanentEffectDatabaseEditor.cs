...
{
    [CustomEditor(typeof(PermanentEffectDatabase))]
    public class PermanentEffectDatabaseEditor : Editor
    {
        ...
        private PermanentEffectData newEffect;
        private PermanentEffectDatabase database;
        private StatusStackDatabase statusStackDatabase;

        private PermanentEffectData[] data;

        private void OnEnable()
        {
            newEffect = new PermanentEffectData();
            database = (PermanentEffectDatabase)target;
