...
{
    public class SayCommandWorker : BaseCommandWorker
    {
        private readonly ICredentialProvider credentialProvider;

        public SayCommandWorker(CommandInstruction instruction, ICredentialProvider credentialProvider) : base(instruction)
        {
        ...
        public override void Perform(int connectionId, params string[] parameters)
        {
            ...
            var message = new ChatBroadcastMessage(ticks, (ushort)ChatLevel.Say, sender, sentence);
            NetworkServer.SendToReadyObservers(connection.identity, message);
        }
    }
}