...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
        ...
        public GameObject CreateEmptyGameObject(string name, Transform parent)
        {
            return CreateEmptyGameObject(new GameObjectCreationParameters { Name = name, ParentTransform = parent }, null);
        }
        ...
        public T InstantiateComponentOnNewGameObject<T>(Transform parent)
            where T : Component
        {
            return InstantiateComponent<T>(
                CreateEmptyGameObject(typeof(T).Name, parent));
        }
        ...
        public T InstantiatePrefabForComponent<T>(
            UnityEngine.Object prefab, Vector3 position)
        {
            return (T)InstantiatePrefabForComponent(
